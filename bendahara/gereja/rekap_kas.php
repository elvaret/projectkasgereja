...
<div class="alert alert-info alert-dismissible">
	...
	<h5>
		<i class="icon fas fa-info"></i> Saldo Keuangan Gereja</h5>
	<h5>Pemasukan :
		<?php
  echo rupiah($masuk);
  ?>
...
<div class="card card-primary">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Rekap Keuangan Gereja</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
		<div class="table-responsive">
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<?php
              $no = 1;
              $sql = $koneksi->query("select * from kas_gereja order by tgl_km asc");
              while ($data= $sql->fetch_assoc()) {
            ?>
