<div class="alert alert-success alert-dismissible">
	...
	<h5>
		<i class="icon fas fa-info"></i> Total Pemasukan Gereja</h5>
	<?php
...
<div class="card card-info">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data Pemasukan Keuangan</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
		<div class="table-responsive">
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<?php
              $no = 1;
              $sql = $koneksi->query("select * from kas_gereja where jenis='Masuk' order by tgl_km desc");
              while ($data= $sql->fetch_assoc()) {
            ?>
