<div class="alert alert-danger alert-dismissible">
	...
	<h5>
		<i class="icon fas fa-info"></i> Total Pengeluaran Gereja</h5>
	<?php
    $sql = $koneksi->query("SELECT SUM(keluar) as tot_masuk  from kas_gereja where jenis='Keluar'");
...
<div class="card card-info">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-table"></i> Data Pengeluaran Keuangan</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
		<div class="table-responsive">
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
					...
					<?php
              $no = 1;
              $sql = $koneksi->query("select * from kas_gereja where jenis='Keluar' order by tgl_km desc");
              while ($data= $sql->fetch_assoc()) {
            ?>
